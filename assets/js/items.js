const ITEMS=[
		...
		},
		{
			...
			"price": 40,
			"itemlevel": 1,
			"ability": [{ "type": "AP", "value": 20, "type_kor": "주문력" }],
			"children": [],
			"parents": [4, 38],
			"summary": {
				"kor": "주문력",
		...
		},
		{
			...
			"itemlevel": 3,
			"ability": [
				{ "type": "AP", "value": 100, "type_kor": "주문력" },
		...
		},
		{
			...
			"children": [25, 27],
			"parents": [],
			"unique_effect": "On attack, additionally deals 10% of target`s maximum HP as magic damage",
			"unique_effect_kor": "공격시 대상 최대체력의 10%의 추가 마법 피해를 입힘",
			"summary": {
				"kor": "공격시 추가피해",
		...
		},
		{
			...
			"children": [],
			"parents": [22, 31],
			"unique_effect": "On attack, additionally deals 5% of target`s maximum HP as magic damage",
			"unique_effect_kor": "공격시 대상 최대체력의 5%의 추가 마법 피해를 입힘",
			"summary": {
				"kor": "공격시 추가피해",
				"eng": "Additional damage on attack"
			},
		...
		},
		{
			...
			"children": [30, 27, 25],
			"parents": [],
			"unique_effect": "40% armor and magic penetration and additionally deals 7% of target`s maximum HP as fixed damage on attack",
			"unique_effect_kor": "적 방어력과 마법저항력을 40% 무시하고 공격시 대상 최대체력의 7%의 추가 고정 피해를 입힘",
			"summary": {
				"kor": "탱커 대항",
				"eng": "Anti-tank"
			},
		...
		},
		{
			...
			"children": [21, 21, 11],
			"parents": [],
			"unique_effect": "Max Hp increases by 5 permanently on every attack",
			"unique_effect_kor": "적 공격시 최대체력 5 영구 증가",
			"summary": {
				"kor": "최대체력",
				"eng": "Maximum HP"
			},
